...
public class Commentate implements Serializable {
    ...
    /**
     * Texto descriptivo del comentario. Mapeado como tipo TEXT en la base de datos.
     */
     ...
     * Utiliza {@code MapsId} para sincronizar con la clave primaria compuesta.
     */
    @ManyToOne
    ...
    /**
     * Libro al que hace referencia el comentario.
     * Utiliza {@code MapsId} para sincronizar con la clave primaria compuesta.
     */
    @ManyToOne
    ...
    /**
     * Crea un nuevo comentario inicializando la fecha de creación y la clave compuesta.
    ...
    /**
     * Devuelve la fecha de creación formateada como cadena de texto (dd/MM/yyyy).
