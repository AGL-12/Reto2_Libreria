 ...
 * sean integrados como parte de otra entidad en la base de datos.
 * * Implementa {@link Serializable} para permitir la persistencia y el manejo
 * de la clave por parte de Hibernate/JPA.
 * * @author alex
 * @version 1.0
 */
@Embeddable
public class CommentateId implements Serializable {
     ...
     * Coincide con la clave primaria (PK) de la entidad User/Profile.
     */
     ...
     * Requerido por JPA/Hibernate para la instanciación de la clave.
     */
    public CommentateId() {
    }
    ...
    /**
     * Compara esta instancia con otro objeto para verificar su igualdad.
     * Es obligatorio sobrescribir este método en claves compuestas de JPA.
     * * @param o Objeto a comparar.
     * @return true si ambos objetos tienen el mismo userCode e isbnBook; false en caso contrario.
     */
    @Override
    ...
    /**
     * Genera un valor hash basado en los atributos de la clave compuesta.
     * Es obligatorio sobrescribir este método en claves compuestas de JPA para el correcto
     * funcionamiento de colecciones y caché de persistencia.
